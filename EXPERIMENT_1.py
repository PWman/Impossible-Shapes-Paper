...
def initialise_networks():
    ...
    nets = [
        ...
        {"name": config.net_names[1], "net": vgg, "train": vgg},
        {"name": config.net_names[2], "net": resnet, "train": resnet},
        {"name": config.net_names[3], "net": incept, "train": incept},
        {"name": config.net_names[4], "net": alex_pt, "train": alex_pt.classifier},
        {"name": config.net_names[5], "net": vgg_pt, "train": vgg_pt.classifier},
        {"name": config.net_names[6], "net": resnet_pt, "train": resnet_pt.fc},
        {"name": config.net_names[7], "net": incept_pt, "train": incept_pt.fc}
    ]
    return nets
